                    ...
                    <div className={styles["footer__columns"]}>
                        ...
                        <div className={styles["footer__column"]}>
                            ...
                            <div className={styles["footer__socials"]}>
                                <a href="https://www.instagram.com/jetreex.uk" target="_blank" rel="noopener noreferrer"
                                   aria-label="Instagram" className={styles["footer__social-link"]}>
                                    <FaInstagram/>
                                </a>
                                <a href="https://www.linkedin.com/company/jetreex/" target="_blank" rel="noopener noreferrer"
